...
本文用于检查 `apps/web` 当前文档、边界、页面、状态、展示规则与实现层路线是否仍与代码一致，并确认后续迭代不会重新回退到过时设计。

## 使用方式

在继续实现或调整文档前，逐项确认以下清单。若关键项未完成，应优先补文档，而不是直接继续扩展功能。
...
- [ ] `Real-API-First + Adapter-First` 的当前联调策略已明确
